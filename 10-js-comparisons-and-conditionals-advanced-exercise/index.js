 ...
 */
const isAccessGranted = (age, favoriteLanguage) => {
 ...
 */
const greeting = (age, favoriteLanguage) => {
  if (age >= 18 && favoriteLanguage === "JavaScript") {
 ...
 */
const greetOnLocalLanguage = (favoriteCity) => {
  switch (favoriteCity) {
    case (favoriteCity = "London"):
      return "Hello";
    case (favoriteCity = "Paris"):
      return "Bonjour";
    case (favoriteCity = "Milan"):
      return "Ciao";
    case (favoriteCity = "Barcelona"):
      return "Hola";
    default:
